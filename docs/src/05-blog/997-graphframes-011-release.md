...
Want to try it? [Wherobots](https://www.wherobots.com/) is the only cloud platform shipping a modern version of GraphFrames. No setup, no jar hunting, just graphs.
